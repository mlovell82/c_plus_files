...
#include "profile.hpp"
profile sort_lib_cpp("sort_lib_cpp");
#include "profile.hpp"
profile sort_lib_h("sort_lib_h");
#include "profile.hpp"
profile sort_cpp("sort_cpp");
//==============================================================================
#include "sort_lib.h"
#include <iostream>
#include <iomanip>
...
{sort_cpp.count(__LINE__, "main");
    ...
    if(opts._output_data)
        { cout << "\nData Before: "; output_data(data); }sort_cpp.count(__LINE__); 
    ...
    if(opts._output_sorted_data)
        { cout << "\nData After: "; output_data(data); }sort_cpp.count(__LINE__); 

    std::cout << sort_cpp << std::endl;
std::cout << sort_lib_h << std::endl;
